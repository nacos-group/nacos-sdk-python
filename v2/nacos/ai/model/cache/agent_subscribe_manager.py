...
class AgentSubscribeManager:
	...
	def __init__(self):
		self.subscribers: dict[str, List[Callable[[str, AgentCard], Awaitable[None]]]] = {}
		self.lock = asyncio.Lock()

	async def register_subscriber(self,agent_name:str, version:str, callback_func: Callable[[str, AgentCard], Awaitable[None]]):
	...
	async def deregister_subscriber(self, agent_name:str, version:str, callback_func: Callable[[str, AgentCard], Awaitable[None]]):
