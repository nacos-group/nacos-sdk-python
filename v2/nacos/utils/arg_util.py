...
arg_parser.add_argument("--user_home", "-u", type=str)
arg_parser.add_argument("--com_alibaba_nacos_client_naming_local_ip", "-i", type=str)
arg_parser.add_argument("--line_separator", "-l", type=str)
